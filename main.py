...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'sankatmochak@gmail.com' ")
...
def TrackImages():
    ...
    if exists1:
        ...
        mess._show(title='Details Missing', message='Persons details are missing, please check!')
        cam.release()
        cv2.destroyAllWindows()
        window.destroy()
    while True:
...
window.title("Sankatmochak Attendance ")
...
message3 = tk.Label(window, text="Sankatmochak Attendance" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
head2 = tk.Label(frame2, text="                       For Adding Member detail                    ", fg="black",bg="#00fcca" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Attendance                              ", fg="black",bg="#00fcca" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Sankatmochak Id ",width=20  ,height=1  ,fg="black"  ,bg="#c79cff" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)
...
lbl3 = tk.Label(frame1, text="taking",width=20  ,fg="black"  ,bg="#c79cff"  ,height=1 ,font=('comic', 17, ' bold '))
...
if exists:
    ...
    res = 0
message.configure(text='Total Persons till now  : '+str(res))
...
tv.heading('#0',text ='Sankatmochak ID')
...
trackImg = tk.Button(frame1, text="Taking Attendance", command=TrackImages  ,fg="black"  ,bg="#3ffc00"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
